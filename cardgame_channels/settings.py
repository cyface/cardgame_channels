"""
Django settings for cardgame_channels project.
...
SECRET_KEY = '+^(prp-&lb4smc_&0$4^=#3xtjb$6ocp)evati!*1#!_z_hxkq'
...
ROOT_URLCONF = 'cardgame_channels.urls'
...
WSGI_APPLICATION = 'cardgame_channels.wsgi.application'
